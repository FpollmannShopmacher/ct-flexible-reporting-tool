...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="https://www.shopmacher.de/wp-content/uploads/2021/12/SM-Favicon.png">

    <title>CT Reporting Tool</title>
    <!-- Fonts -->
    <link rel="preconnect" href="https://fonts.bunny.net">
    <link href="https://fonts.bunny.net/css?family=figtree:400,500,600&display=swap" rel="stylesheet"/>

    <!-- Styles / Scripts -->
    {{--    ToDo: main.blade teplate als basic template erstellen--}}
...
<!--ToDo: Head in eigenes Template auslagern-->
...
<div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
    ...
    <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
        <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
            ...
            <main class="mt-6 grid gap-6 lg:grid-cols-2 lg:gap-8">
                <x-formTile title="Create Order Statistic"
                            text="Select your needed Sorting and Filter Params for your Order statistic"
                >
                    <x-slot:childs>
                        <form method="get" action="{{route('statistics.fetch-statistic')}}" name="fetch-statistic"
                              id="fetch-statistic">
                            <div class="flex justify-between">
                                    ...
                                    <div class="grid grid-cols-2 gap-x-4">
                                        <div>
                                            <input type="checkbox" id="day" name="period-day"
                                                   @if(isset($orderCounts['day'])||isset($orderSales['day'])) checked @endif
                                            />
                                            <label for="day">Day</label>
                                        </div>
                                        <div>
                                            <input type="checkbox" id="week" name="period-week"
                                                   @if(isset($orderCounts['week'])||isset($orderSales['week'])) checked @endif
                                        ...
                                        <div>
                                            <input type="checkbox" id="month" name="period-month"
                                                   @if(isset($orderCounts['month'])||isset($orderSales['month'])) checked @endif
                                            />
                                            <label for="month">Month</label>
                                        </div>
                                        <div>
                                            <input type="checkbox" id="year" name="period-year"
                                                   @if(isset($orderCounts['year'])||isset($orderSales['year'])) checked @endif
                                            />
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-2 gap-x-4">
                                        ...
                                        <div>
                                            <input type="checkbox" id="average-order-value"
                                                   name="data-average-order-value"/>
                ...
                @if(isset($orderSales)|| isset($orderCounts))
                            ...
                            <div class="overflow-x-auto">
                                <table class="min-w-full bg-white text-black dark:bg-black dark:text-white">
                                    ...
                                    <tr class="bg-gray-200 dark:bg-gray-700">
                                        ...
                                        @foreach($orderSales ?? $orderCounts as $key => $value)
                                ...
                                <form method="get" action='{{route('statistics.download')}}'>
                                    <div class="inline-flex justify-between items-center w-full">
                                        <h1>Fetch Stats as: </h1>
                                        @php
                                            $jsonOrderData = "";
